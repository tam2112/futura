...
export default async function ColorListPage({ searchParams }: { searchParams: { [key: string]: string | undefined } }) {
    ...
    const columns = [
        ...
        { header: 'Hex', accessor: 'hex', className: 'hidden md:table-cell' },
    ];
        ...
        <>
            ...
            <div className="bg-white p-4 rounded-md flex-1 m-4 mt-0">
                <div className="flex items-center justify-between">
                    <h1 className="hidden md:block text-lg font-semibold">All Colors</h1>
                    <div className="flex flex-col md:flex-row items-center gap-4 w-full md:w-auto">
                        ...
                        <div className="flex items-center gap-4 self-end">
                            ...
                            <FilterTechnicalDropdown
                                ...
                                entityName="Color"
                            />
                            <ExportButton exportAction={exportColors} entityName="Color" />
                            <FormContainer table="color" type="create" />
                            <DeleteSelectedButtonClient deleteAction={deleteSelectedColors} entityName="Color" />
                        </div>
                    </div>
                </div>
