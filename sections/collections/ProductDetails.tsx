...
type Product = {
    ...
    connectivity?: { id: string; name: string } | null;
    simSlot?: { id: string; title: string } | null;
    batteryHealth?: { id: string; title: string } | null;
    ram?: { id: string; title: string } | null;
    cpu?: { id: string; name: string } | null;
    screenSize?: { id: string; name: string } | null;
    type?: { id: string; name: string } | null;
    category: { name: string; slug: string };
    status?: { id: string; name: string } | null;
    promotions?: { percentageNumber: number }[] | null;
    isFavourite: boolean;
};
